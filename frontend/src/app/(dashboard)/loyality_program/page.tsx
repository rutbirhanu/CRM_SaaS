      ...
      <div className="w-full p-6">
        ...
        <div className="grid md:grid-cols-2 gap-3 mb-8">
          <Card className="p-6 rounded-xl shadow-xl">
            <h3 className="text-[16px] font-semibold text-gray-800">Your Loyalty Points</h3>
        ...
        <div className="mb-8">
          ...
          <div className="grid md:grid-cols-3 gap-6 ">
            <Card className="p-6 rounded-xl shadow-xl bg-blue-50 w-full">
              ...
              <p className="text-sm text-gray-600">Redeem with 500 points</p>
            ...
            <Card className="p-6 rounded-xl shadow-xl bg-yellow-50 w-full">
              ...
              <p className="text-sm text-gray-600">Redeem with 800 points</p>
            ...
            <Card className="p-6 rounded-xl shadow-xl bg-green-50 w-full">
              ...
              <p className="text-sm text-gray-600">Redeem with 1,000 points</p>
